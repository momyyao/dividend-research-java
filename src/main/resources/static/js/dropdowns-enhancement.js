/*
 * Copyright (c) 2015.  Interactive Advisory Software, LLC  All rights reserved.
 * This software is the property of Interactive Advisory Software, LLC and its third-party licensors,
 * as applicable, and is protected under United States of America copyright laws and international
 * copyright treaties.  The structure, organization, and code of the software are and shall remain valuable
 * trade secrets of Interactive Advisory Software, LLC and its third-party licensors, as applicable.  All title,
 * ownership rights, and intellectual property rights not expressly granted by Interactive Advisory Software,
 * LLC are retained by Interactive Advisory Software, LLC  Any attempt to decompile, disassemble, modify,
 * reverse engineer, or create derivative works from, the software, or reduce its code to human readable
 * form, is prohibited and illegal.
 */
